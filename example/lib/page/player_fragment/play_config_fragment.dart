...
class _PlayConfigFragmentState extends State<PlayConfigFragment> {
  ...
  _getPlayerConfig() async {
    ...
    _mLiveStartIndex = TextEditingController.fromValue(
        TextEditingValue(text: _configMap['mLiveStartIndex'].toString()));
    _mPositionTimerIntervalMs = TextEditingController.fromValue(
        TextEditingValue(
            text: _configMap['mPositionTimerIntervalMs'].toString()));
    _mMaxBackwardBufferDurationMs = TextEditingController.fromValue(
        TextEditingValue(
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      var configMap = {
                        'mMaxAllowedAbrVideoPixelNumber': PixelNumber.Resolution_360P.toInt(),
                        ...
                        "mPositionTimerIntervalMs":
                            _mPositionTimerIntervalMs?.text,
                        "mMaxBackwardBufferDurationMs":
                            _mMaxBackwardBufferDurationMs?.text
                      };
                      // widget.fAliplayer.setConfig(configMap);
                      widget.fAliplayer.setPlayConfig(AVPConfig.convertAt(configMap));
